...
// Code Here
let doubled = myNumbers.map(el => el * 2);
...
// Code Here
let filtered = myNumbers.filter(el => el > 100);
//////////////////PROBLEM 16////////////////////
...
// Code Here
let total = myNumbers.reduce((arr, val) => arr + val);
//////////////////PROBLEM 17////////////////////
...
// Code Here
let forTheLoveOfGeorge = notGeorge.map(el => 'George') ;
//////////////////PROBLEM 19////////////////////
...
// Code Here
let totallyAwesome = people.reduce((total,val) => total + val.awesomeLevel,0 );